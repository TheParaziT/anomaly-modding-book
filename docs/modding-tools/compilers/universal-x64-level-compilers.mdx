...
<ProgramDescription 
  program={{
    name: "Universal x64 Level Compilers",
    version: "1.6 beta",
    developers: ["gsc_game_world", "skyloaderr", "abramcumner", "kd"],
    previewImage: "/img/universal-x64-level-compilers.png",
    forum: [
      "https://ap-pro.ru/forums/topic/3341-universalnye-kompilyatory-urovney-h64",
    ],
  }}
  maxAddonsToShow={2}
/>
